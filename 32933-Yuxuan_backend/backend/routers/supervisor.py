...
def create_project(
    ...
    result = supervisor_crud.create_project(db, supervisor_id, project)
    if not result:
...
def update_project(
    ...
    if user["email"] is None or user["user_group_identifier"] != "supervisor":
...
def update_my_info(
    ...
    return {
        ...
        "user_group_identifier": updated.user_group_identifier
    }
